...
public class PeticionarioRESTWorker extends Worker {
    ...
    /**
     * @brief Constructor para el Worker.
     *
    ...
    /**
     * @brief Ejecuta la tarea del Worker, que es realizar una solicitud REST.
     *      *
    ...
    /**
     **
     * @brief Configura la conexión HTTP para la solicitud REST.
     *
    ...
    /**
     * @brief Muestra un mensaje Toast en el hilo de la UI.
     *
