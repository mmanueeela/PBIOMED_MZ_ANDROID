...
// ------------------------------------------------------------------
// @class MainActivity
// @brief Controla la actividad principal de la aplicación que escanea dispositivos Bluetooth LE,
...
public class MainActivity extends AppCompatActivity {
    ...
    // --------------------------------------------------------------
    // @brief Etiqueta de log para la depuración
    // --------------------------------------------------------------
    private static final String ETIQUETA_LOG = ">>>>";

    // --------------------------------------------------------------
    // @brief Escáner Bluetooth LE
    // --------------------------------------------------------------
    private BluetoothLeScanner elEscanner;

    // --------------------------------------------------------------
    // @brief Callback para los resultados de escaneo
    // --------------------------------------------------------------
    private ScanCallback callbackDelEscaneo = null;

    // --------------------------------------------------------------
    // @brief Cadena UUID específica para filtrar dispositivos
    // --------------------------------------------------------------
    private final String uuidString = "holaMundoManuela";

    //---------------------------------------------------------------
    // @brief Objeto para manejar la trama iBeacon
    //---------------------------------------------------------------
    ...
    // --------------------------------------------------------------
    // @brief Muestra información detallada sobre un dispositivo Bluetooth LE detectado.
    ...
    // --------------------------------------------------------------
    //  @brief Inicia la búsqueda de un dispositivo Bluetooth LE específico.
    ////        Filtra por UUID.
    //// @throws SecurityException si no se tiene el permiso BLUETOOTH_SCAN.
    // --------------------------------------------------------------
    private void buscarEsteDispositivoBTLE() {
        ...
        this.callbackDelEscaneo = new ScanCallback() {
            /**
             * @brief Maneja los resultados del escaneo cuando se detecta un dispositivo.
             *
             * @param callbackType int: Tipo de callback.
             * @param resultado ScanResult: Resultado del escaneo de un dispositivo.
             * @throws SecurityException si no se tiene el permiso BLUETOOTH_CONNECT.
             */
            ...
            /**
             * @brief Maneja los resultados del escaneo en lote.
             *
             * @param results List<ScanResult>: Lista de resultados del escaneo en lote.
             */
            ...
            /**
             * @brief Maneja los fallos en el escaneo.
             *
             * @param errorCode int: Código de error.
             */
    ...
    // --------------------------------------------------------------
    // @brief Muestra el valor "Major" del dispositivo iBeacon detectado
    // --------------------------------------------------------------
    ...
    // --------------------------------------------------------------
    // @brief Método que se ejecuta cuando se pulsa el botón para buscar dispositivos BTLE.
    ...
    // --------------------------------------------------------------
    // @brief Método que se ejecuta cuando se pulsa el botón para buscar un dispositivo BTLE específico.
    //     * @param v View: la vista que fue pulsada.
    // --------------------------------------------------------------
    ...
    // --------------------------------------------------------------
    // @brief Método que se ejecuta cuando se pulsa el botón para detener la búsqueda de dispositivos BTLE.
    //     * @param v View: la vista que fue pulsada.
    // --------------------------------------------------------------
    ...
    // --------------------------------------------------------------
    // @brief Método que se ejecuta cuando se pulsa el botón para enviar un POST de prueba.
    //     * @param v View: la vista que fue pulsada.
    // --------------------------------------------------------------
    ...
    //----------------------------------------------------------------
    // @brief Método para enviar una petición POST de prueba.
    //----------------------------------------------------------------
    ...
    //----------------------------------------------------------------
    // @brief Método que se ejecuta al crear la actividad principal.
    ...
    //----------------------------------------------------------------
    // @brief Lanzador de actividad para solicitar permisos.
    //----------------------------------------------------------------
