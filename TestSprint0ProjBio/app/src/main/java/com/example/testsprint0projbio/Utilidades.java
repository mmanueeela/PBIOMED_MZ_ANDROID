...
//Clase Utilidades: Proporciona métodos estáticos para manipulación de bytes, UUIDs y conversiones.
public class Utilidades {
    ...
    // -------------------------------------------------------------------------------
    // Convierte una cadena de 16 caracteres en un UUID.
    ...
    // -------------------------------------------------------------------------------
    // Convierte un UUID en una cadena de texto.
    ...
    // -------------------------------------------------------------------------------
    // Convierte un UUID en una cadena hexadecimal.
    //     * @param uuid UUID: El UUID a convertir.
    ...
    // -------------------------------------------------------------------------------
    // Convierte un arreglo de bytes en un entero, manejando posibles errores.
    //     * @param bytes byte[]: El arreglo de bytes a convertir.
    //     * @return int: El entero resultante.
