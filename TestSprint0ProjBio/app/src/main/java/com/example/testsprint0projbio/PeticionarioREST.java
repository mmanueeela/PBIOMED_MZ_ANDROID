...
//// @brief Maneja las peticiones HTTP REST de forma asíncrona.
// ------------------------------------------------------------------------
public class PeticionarioREST extends AsyncTask<Void, Void, Boolean> {

    // --------------------------------------------------------------------
    // @interface RespuestaREST
    // @brief Proporciona un método de callback para manejar la respuesta de la petición REST.
    // --------------------------------------------------------------------
    ...
    // --------------------------------------------------------------------
    // @brief Método para realizar una petición REST.
    ...
    // --------------------------------------------------------------------
    // @brief Constructor por defecto de la clase PeticionarioREST.
    // --------------------------------------------------------------------
    ...
    // --------------------------------------------------------------------
    // @brief Método que se ejecuta en un hilo separado para realizar la petición HTTP.
    ...
    // --------------------------------------------------------------------
    // @brief Método que se ejecuta después de doInBackground() para manejar los resultados en el hilo principal.
